...
class ResNetSmall(nn.Module):
    def __init__(self, block, layers=[3, 3, 4], num_input_channels=1, dim=256):
        self.inplanes = 64
        super().__init__()
        ...
        self.layer3 = self._make_layer(block, dim, layers[2], stride=2)
...
def resnet_small(**kwargs):
    return ResNetSmall(BasicBlock, **kwargs)
